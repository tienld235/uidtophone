          ...
          <div class="col-12">
            <form method="POST" action="/">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="user_id" class="form-control" id="user_id" placeholder="Example: 01234567890">
                </div>
            ...
            <form method="POST" action="/excel">
                ...
                <button type="submit" class="btn btn-success col-3">Export</button>
            </form>
          </div>
        </div>
      </div>
